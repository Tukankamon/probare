...
-- at runtime using the environment variable proof_bindir.
...
-- environment variable proof_libdir.
...
-- using the environment variable proof_dynlibdir.
...
-- runtime using the environment variable proof_datadir.
...
-- using the environment variable proof_sysconfdir.
...
bindir     = "/home/aved/.cabal/bin"
libdir     = "/home/aved/.cabal/lib/x86_64-linux-ghc-9.10.3-d332/proof-0.1.0.0-inplace-proof"
dynlibdir  = "/home/aved/.cabal/lib/x86_64-linux-ghc-9.10.3-d332"
datadir    = "/home/aved/.cabal/share/x86_64-linux-ghc-9.10.3-d332/proof-0.1.0.0"
libexecdir = "/home/aved/.cabal/libexec/x86_64-linux-ghc-9.10.3-d332/proof-0.1.0.0"
sysconfdir = "/home/aved/.cabal/etc"

getBinDir     = catchIO (getEnv "proof_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "proof_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "proof_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "proof_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "proof_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "proof_sysconfdir") (\_ -> return sysconfdir)
